  ...
  return (
    <footer className="disable-select relative mt-auto" dir="rtl">
      <div className="bg-gray-200">
        <div className="portlet" id="yw18">
          <div className="portlet-content">
            <div
              className="flex flex-col lg:flex-row justify-between text-gray-800 p-6 text-sm max-w-screen-xl mx-auto"
              dir="rtl"
            >
      ...
      <div className="bg-gray-100">
        <div
          className="max-w-screen-xl mx-auto px-4 flex flex-col lg:flex-row gap-8 py-4 lg:py-8"
          dir="rtl"
        >
          ...
          <div className="mt-4 md:mt-0 flex-1">
            <div className="font-bold text-xl text-gray-800 mb-4 text-right">
            ...
            <div className="text-gray-600 leading-7 text-justify" dir="rtl">
              <div className="portlet" id="yw19">
                <div className="portlet-content text-right">
                  ...
                  از سال 1398 از طریق پیج اینستاگرام وارد فروش آنلاین شد و به
                  خاطر ارائه کالای اصلی و مشاوره های دقیق در بازه بسیار کوتاهی
                  توانست اعتماد بسیاری از مشتریانش را جلب کند و سرانجام در سال
                  1399 فروش از طریق سایت را هم به فعالیت های خود اضافه کرد تا
                  اینکه بتواند با بررسی دقیق کالاها انتخاب صحیح شما را به ارمغان
                  آورد. و امروز دسترسی فعالیت خود را در زمینه آداپتور موبایل،
                  کابل شارژ، پاوربانک، ساعت هوشمند، هندزفری و هدست، لوازم
                  گیمینگ، باتری و شارژر، لوازم شبکه، تجهیزات ذخیره سازی، گیرنده
          ...
          <div className="w-full lg:w-auto">
            <h3 className="font-bold text-xl mb-4 text-right text-gray-800">
              دسترسی سریع
            </h3>
              ...
              <div className="portlet-content">
                <div className="flex flex-row gap-16 justify-between" dir="rtl">
                  <div className="flex flex-col text-right">
                    <a
                      href="/customer-club"
                      className="text-sm text-gray-600 hover:text-black mb-4 block transition-colors duration-200"
                    >
                      باشگاه مشتریان
                    </a>
                    <a
      ...
      <div
        className="font-medium text-sm text-center bg-blue-600 text-white py-3"
        dir="rtl"
      >
